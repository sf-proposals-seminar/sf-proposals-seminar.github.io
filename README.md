...
(2018/06/14追記)　このセミナーはプロポーザルを検討することを主な目的としているため、研究発表や既存の論文を紹介することは場ではありません。ただし、プロポーザルの導入として先行紹介(これまで自身が行ってきたものや他のグループの研究)を紹介する必要があるかと思いますので、間接的に研究発表や論文紹介の場と捉えていただいても良いかと思います。
